...
Tree.text_print(scalar"i" * 2 * scalar"j"^(scalar"i" + 1))
Tree.text_print(canonicalize(scalar"i" * 2 * scalar"j"^(scalar"i" + 1)))
Tree.text_print(0 - 2 * scalar"i"^3 + 3 * scalar"i"^3)
Tree.text_print(canonicalize(0 - 2 * scalar"i"^3 + 3 * scalar"i"^3))
Data.pprint(scalar"i" * 2 * scalar"j"^(scalar"i" + 1))
